...
struct CD3DX12_PIPELINE_STATE_STREAM2
{
    ...
    D3D12_GRAPHICS_PIPELINE_STATE_DESC GraphicsDescV0() const noexcept
    {
        ...
        D.DepthStencilState = CD3DX12_DEPTH_STENCIL_DESC1(static_cast<D3D12_DEPTH_STENCIL_DESC1>(this->DepthStencilState));
        D.DSVFormat = this->DSVFormat;
        D.RasterizerState = this->RasterizerState;
        D.NumRenderTargets = static_cast<D3D12_RT_FORMAT_ARRAY>(this->RTVFormats).NumRenderTargets;
        memcpy(D.RTVFormats, static_cast<D3D12_RT_FORMAT_ARRAY>(this->RTVFormats).RTFormats, sizeof(D.RTVFormats));
