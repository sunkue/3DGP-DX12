...
__interface IShaderResourceHelper
{
public:
	virtual void CreateShaderVariables(ID3D12Device* device, ID3D12GraphicsCommandList* commandList) abstract = 0;
	virtual void ReleaseShaderVariables() abstract = 0;
	virtual void UpdateShaderVariables(ID3D12GraphicsCommandList* commandList) abstract = 0;
};
